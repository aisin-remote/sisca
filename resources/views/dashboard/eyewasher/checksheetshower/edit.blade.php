        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <select class="form-select" id="wastafel" name="wastafel">
                            <option value="" selected disabled>Select</option>
                            <option value="OK"
                                {{ old('wastafel') ?? $checkSheetshower->wastafel == 'OK' ? 'selected' : '' }}>OK
                            </option>
                            <option value="NG"
                                {{ old('wastafel') ?? $checkSheetshower->wastafel == 'NG' ? 'selected' : '' }}>NG
                            </option>
                        </select>
                ...
                <div class="mb-3 mt-3" id="catatanField_wastafel" style="display:none;">
                    ...
                    <textarea class="form-control" name="catatan_wastafel" id="catatan_wastafel" cols="30" rows="5">{{ old('catatan_wastafel') ?? $checkSheetshower->catatan_wastafel }}</textarea>
                </div>
                <div class="mb-3">
                    <label for="photo_wastafel" class="form-label">Foto Wastafel</label>
                    <input type="hidden" name="oldImage_wastafel" value="{{ $checkSheetshower->photo_wastafel }}">
                    @if ($checkSheetshower->photo_wastafel)
                        <img src="{{ asset('storage/' . $checkSheetshower->photo_wastafel) }}"
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <select class="form-select" id="kran_air" name="kran_air">
                            <option value="" selected disabled>Select</option>
                            <option value="OK"
                                {{ old('kran_air') ?? $checkSheetshower->kran_air == 'OK' ? 'selected' : '' }}>OK
                            </option>
                            <option value="NG"
                                {{ old('kran_air') ?? $checkSheetshower->kran_air == 'NG' ? 'selected' : '' }}>NG
                            </option>
                        </select>
                ...
                <div class="mb-3 mt-3" id="catatanField_kran_air" style="display:none;">
                    ...
                    <textarea class="form-control" name="catatan_kran_air" id="catatan_kran_air" cols="30" rows="5">{{ old('catatan_kran_air') ?? $checkSheetshower->catatan_kran_air }}</textarea>
                </div>
                <div class="mb-3">
                    <label for="photo_kran_air" class="form-label">Foto Kran Air</label>
                    <input type="hidden" name="oldImage_kran_air" value="{{ $checkSheetshower->photo_kran_air }}">
                    @if ($checkSheetshower->photo_kran_air)
                        <img src="{{ asset('storage/' . $checkSheetshower->photo_kran_air) }}"
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <select class="form-select" id="tuas" name="tuas">
                            <option value="" selected disabled>Select</option>
                            <option value="OK"
                                {{ old('tuas') ?? $checkSheetshower->tuas == 'OK' ? 'selected' : '' }}>OK</option>
                            <option value="NG"
                                {{ old('tuas') ?? $checkSheetshower->tuas == 'NG' ? 'selected' : '' }}>NG</option>
                        </select>
                ...
                <div class="mb-3 mt-3" id="catatanField_tuas" style="display:none;">
                    ...
                    <textarea class="form-control" name="catatan_tuas" id="catatan_tuas" cols="30" rows="5">{{ old('catatan_tuas') ?? $checkSheetshower->catatan_tuas }}</textarea>
                </div>
                <div class="mb-3">
                    <label for="photo_tuas" class="form-label">Foto Tuas</label>
                    <input type="hidden" name="oldImage_tuas" value="{{ $checkSheetshower->photo_tuas }}">
                    @if ($checkSheetshower->photo_tuas)
                        <img src="{{ asset('storage/' . $checkSheetshower->photo_tuas) }}"
