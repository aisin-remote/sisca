...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <form action="{{ route('eyewasher.checksheetshower.update', $checkSheetshower->id) }}" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="tanggal_pengecekan"
                            value="{{ $checkSheetshower->tanggal_pengecekan }}" name="tanggal_pengecekan" required
                            readonly>
                    </div>
                    <div class="mb-3">
                        <label for="npk" class="form-label">NPK</label>
                        <input type="text" class="form-control" id="npk" name="npk"
                            value="{{ $checkSheetshower->npk }}" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="eyewasher_number" class="form-label">Nomor Eyewasher</label>
                        <input type="text" class="form-control" id="eyewasher_number"
                            value="{{ $checkSheetshower->eyewasher_number }}" name="eyewasher_number" required autofocus
                            readonly>
                    </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <select class="form-select" id="instalation_base" name="instalation_base">
                            ...
                            <option value="OK"
                                {{ old('instalation_base') ?? $checkSheetshower->instalation_base == 'OK' ? 'selected' : '' }}>OK</option>
                            <option value="NG"
                                {{ old('instalation_base') ?? $checkSheetshower->instalation_base == 'NG' ? 'selected' : '' }}>NG</option>
                        </select>
                        <button type="button" class="btn btn-success" id="tambahCatatan_instalation_base"><i
                ...
                <div class="mb-3 mt-3" id="catatanField_instalation_base" style="display:none;">
                    ...
                    <textarea class="form-control" name="catatan_instalation_base" id="catatan_instalation_base" cols="30" rows="5">{{ old('catatan_instalation_base') ?? $checkSheetshower->catatan_instalation_base }}</textarea>
                </div>
                <div class="mb-3">
                    <label for="photo_instalation_base" class="form-label">Foto Instalation Base</label>
                    <input type="hidden" name="oldImage_instalation_base" value="{{ $checkSheetshower->photo_instalation_base }}">
                    @if ($checkSheetshower->photo_instalation_base)
                        <img src="{{ asset('storage/' . $checkSheetshower->photo_instalation_base) }}"
                            class="photo-instalation_base-preview img-fluid mb-3 d-block" style="max-height: 300px">
                    @else
                        <img class="photo-instalation_base-preview img-fluid mb-3" style="max-height: 300px">
                    @endif

                    <input type="file" class="form-control" id="photo_instalation_base" name="photo_instalation_base"
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <select class="form-select" id="pipa_saluran_air" name="pipa_saluran_air">
                            <option value="" selected disabled>Select</option>
                            <option value="OK"
                                {{ old('pipa_saluran_air') ?? $checkSheetshower->pipa_saluran_air == 'OK' ? 'selected' : '' }}>
                                OK</option>
                            <option value="NG"
                                {{ old('pipa_saluran_air') ?? $checkSheetshower->pipa_saluran_air == 'NG' ? 'selected' : '' }}>
                                NG</option>
                        </select>
                ...
                <div class="mb-3 mt-3" id="catatanField_pipa_saluran_air" style="display:none;">
                    ...
                    <textarea class="form-control" name="catatan_pipa_saluran_air" id="catatan_pipa_saluran_air" cols="30"
                        rows="5">{{ old('catatan_pipa_saluran_air') ?? $checkSheetshower->catatan_pipa_saluran_air }}</textarea>
                </div>
                <div class="mb-3">
                    ...
                    <input type="hidden" name="oldImage_pipa_saluran_air"
                        value="{{ $checkSheetshower->photo_pipa_saluran_air }}">
                    @if ($checkSheetshower->photo_pipa_saluran_air)
                        <img src="{{ asset('storage/' . $checkSheetshower->photo_pipa_saluran_air) }}"
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <select class="form-select" id="wastafel_eye_wash" name="wastafel_eye_wash">
                            <option value="" selected disabled>Select</option>
                            <option value="OK"
                                {{ old('wastafel_eye_wash') ?? $checkSheetshower->wastafel_eye_wash == 'OK' ? 'selected' : '' }}>OK
                            </option>
                            <option value="NG"
                                {{ old('wastafel_eye_wash') ?? $checkSheetshower->wastafel_eye_wash == 'NG' ? 'selected' : '' }}>NG
                            </option>
                        </select>
                        <button type="button" class="btn btn-success" id="tambahCatatan_wastafel_eye_wash"><i
                                class="bi bi-bookmark-plus"></i></button>
                    </div>
                </div>
                <div class="mb-3 mt-3" id="catatanField_wastafel_eye_wash" style="display:none;">
                    ...
                    <textarea class="form-control" name="catatan_wastafel_eye_wash" id="catatan_wastafel_eye_wash" cols="30" rows="5">{{ old('catatan_wastafel_eye_wash') ?? $checkSheetshower->catatan_wastafel_eye_wash }}</textarea>
                </div>
                <div class="mb-3">
                    <label for="photo_wastafel_eye_wash" class="form-label">Foto Wastafel Eye Wash</label>
                    <input type="hidden" name="oldImage_wastafel_eye_wash" value="{{ $checkSheetshower->photo_wastafel_eye_wash }}">
                    @if ($checkSheetshower->photo_wastafel_eye_wash)
                        <img src="{{ asset('storage/' . $checkSheetshower->photo_wastafel_eye_wash) }}"
                            class="photo-wastafel_eye_wash-preview img-fluid mb-3 d-block" style="max-height: 300px">
                    @else
                        <img class="photo-wastafel_eye_wash-preview img-fluid mb-3" style="max-height: 300px">
                    @endif

                    <input type="file" class="form-control" id="photo_wastafel_eye_wash" name="photo_wastafel_eye_wash"
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <select class="form-select" id="kran_eye_wash" name="kran_eye_wash">
                            <option value="" selected disabled>Select</option>
                            <option value="OK"
                                {{ old('kran_eye_wash') ?? $checkSheetshower->kran_eye_wash == 'OK' ? 'selected' : '' }}>OK
                            </option>
                            <option value="NG"
                                {{ old('kran_eye_wash') ?? $checkSheetshower->kran_eye_wash == 'NG' ? 'selected' : '' }}>NG
                            </option>
                        </select>
                        <button type="button" class="btn btn-success" id="tambahCatatan_kran_eye_wash"><i
                                class="bi bi-bookmark-plus"></i></button>
                    </div>
                </div>
                <div class="mb-3 mt-3" id="catatanField_kran_eye_wash" style="display:none;">
                    ...
                    <textarea class="form-control" name="catatan_kran_eye_wash" id="catatan_kran_eye_wash" cols="30" rows="5">{{ old('catatan_kran_eye_wash') ?? $checkSheetshower->catatan_kran_eye_wash }}</textarea>
                </div>
                <div class="mb-3">
                    <label for="photo_kran_eye_wash" class="form-label">Foto Kran Eye Wash</label>
                    <input type="hidden" name="oldImage_kran_eye_wash" value="{{ $checkSheetshower->photo_kran_eye_wash }}">
                    @if ($checkSheetshower->photo_kran_eye_wash)
                        <img src="{{ asset('storage/' . $checkSheetshower->photo_kran_eye_wash) }}"
                            class="photo-kran_eye_wash-preview img-fluid mb-3 d-block" style="max-height: 300px">
                    @else
                        <img class="photo-kran_eye_wash-preview img-fluid mb-3" style="max-height: 300px">
                    @endif

                    <input type="file" class="form-control" id="photo_kran_eye_wash" name="photo_kran_eye_wash"
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <select class="form-select" id="tuas_eye_wash" name="tuas_eye_wash">
                            <option value="" selected disabled>Select</option>
                            <option value="OK"
                                {{ old('tuas_eye_wash') ?? $checkSheetshower->tuas_eye_wash == 'OK' ? 'selected' : '' }}>OK</option>
                            <option value="NG"
                                {{ old('tuas_eye_wash') ?? $checkSheetshower->tuas_eye_wash == 'NG' ? 'selected' : '' }}>NG</option>
                        </select>
                        <button type="button" class="btn btn-success" id="tambahCatatan_tuas_eye_wash"><i
                                class="bi bi-bookmark-plus"></i></button>
                    </div>
                </div>
                <div class="mb-3 mt-3" id="catatanField_tuas_eye_wash" style="display:none;">
                    ...
                    <textarea class="form-control" name="catatan_tuas_eye_wash" id="catatan_tuas_eye_wash" cols="30" rows="5">{{ old('catatan_tuas_eye_wash') ?? $checkSheetshower->catatan_tuas_eye_wash }}</textarea>
                </div>
                <div class="mb-3">
                    <label for="photo_tuas_eye_wash" class="form-label">Foto Tuas Eye Wash</label>
                    <input type="hidden" name="oldImage_tuas_eye_wash" value="{{ $checkSheetshower->photo_tuas_eye_wash }}">
                    @if ($checkSheetshower->photo_tuas_eye_wash)
                        <img src="{{ asset('storage/' . $checkSheetshower->photo_tuas_eye_wash) }}"
                            class="photo-tuas_eye_wash-preview img-fluid mb-3 d-block" style="max-height: 300px">
                    @else
                        <img class="photo-tuas_eye_wash-preview img-fluid mb-3" style="max-height: 300px">
                    @endif

                    <input type="file" class="form-control" id="photo_tuas_eye_wash" name="photo_tuas_eye_wash"
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <select class="form-select" id="tuas_shower" name="tuas_shower">
                            <option value="" selected disabled>Select</option>
                            <option value="OK"
                                {{ old('tuas_shower') ?? $checkSheetshower->tuas_shower == 'OK' ? 'selected' : '' }}>OK</option>
                            <option value="NG"
                                {{ old('tuas_shower') ?? $checkSheetshower->tuas_shower == 'NG' ? 'selected' : '' }}>NG</option>
                        </select>
                        <button type="button" class="btn btn-success" id="tambahCatatan_tuas_shower"><i
                                class="bi bi-bookmark-plus"></i></button>
                    </div>
                </div>
                <div class="mb-3 mt-3" id="catatanField_tuas_shower" style="display:none;">
                    ...
                    <textarea class="form-control" name="catatan_tuas_shower" id="catatan_tuas_shower" cols="30" rows="5">{{ old('catatan_tuas_shower') ?? $checkSheetshower->catatan_tuas_shower }}</textarea>
                </div>
                <div class="mb-3">
                    <label for="photo_tuas_shower" class="form-label">Foto Tuas Shower</label>
                    <input type="hidden" name="oldImage_tuas_shower" value="{{ $checkSheetshower->photo_tuas_shower }}">
                    @if ($checkSheetshower->photo_tuas_shower)
                        <img src="{{ asset('storage/' . $checkSheetshower->photo_tuas_shower) }}"
                            class="photo-tuas_shower-preview img-fluid mb-3 d-block" style="max-height: 300px">
                    @else
                        <img class="photo-tuas_shower-preview img-fluid mb-3" style="max-height: 300px">
                    @endif

                    <input type="file" class="form-control" id="photo_tuas_shower" name="photo_tuas_shower"
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <select class="form-select" id="sign" name="sign">
                            <option value="" selected disabled>Select</option>
                            <option value="OK"
                                {{ old('sign') ?? $checkSheetshower->sign == 'OK' ? 'selected' : '' }}>OK</option>
                            <option value="NG"
                                {{ old('sign') ?? $checkSheetshower->sign == 'NG' ? 'selected' : '' }}>NG</option>
                        </select>
                        <button type="button" class="btn btn-success" id="tambahCatatan_sign"><i
                                class="bi bi-bookmark-plus"></i></button>
                    </div>
                </div>
                <div class="mb-3 mt-3" id="catatanField_sign" style="display:none;">
                    <label for="catatan_sign" class="form-label">Catatan Sign</label>
                    <textarea class="form-control" name="catatan_sign" id="catatan_sign" cols="30" rows="5">{{ old('catatan_sign') ?? $checkSheetshower->catatan_sign }}</textarea>
                </div>
                <div class="mb-3">
                    <label for="photo_sign" class="form-label">Foto Sign</label>
                    <input type="hidden" name="oldImage_sign" value="{{ $checkSheetshower->photo_sign }}">
                    @if ($checkSheetshower->photo_sign)
                        <img src="{{ asset('storage/' . $checkSheetshower->photo_sign) }}"
                            class="photo-sign-preview img-fluid mb-3 d-block" style="max-height: 300px">
                    @else
                        <img class="photo-sign-preview img-fluid mb-3" style="max-height: 300px">
                    @endif

                    <input type="file" class="form-control" id="photo_sign" name="photo_sign"
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <select class="form-select" id="shower_head" name="shower_head">
                            <option value="" selected disabled>Select</option>
                            <option value="OK"
                                {{ old('shower_head') ?? $checkSheetshower->shower_head == 'OK' ? 'selected' : '' }}>OK</option>
                            <option value="NG"
                                {{ old('shower_head') ?? $checkSheetshower->shower_head == 'NG' ? 'selected' : '' }}>NG</option>
                        </select>
                        <button type="button" class="btn btn-success" id="tambahCatatan_shower_head"><i
                                class="bi bi-bookmark-plus"></i></button>
                    </div>
                </div>
                <div class="mb-3 mt-3" id="catatanField_shower_head" style="display:none;">
                    ...
                    <textarea class="form-control" name="catatan_shower_head" id="catatan_shower_head" cols="30" rows="5">{{ old('catatan_shower_head') ?? $checkSheetshower->catatan_shower_head }}</textarea>
                </div>
                <div class="mb-3">
                    <label for="photo_shower_head" class="form-label">Foto Shower Head</label>
                    <input type="hidden" name="oldImage_shower_head" value="{{ $checkSheetshower->photo_shower_head }}">
                    @if ($checkSheetshower->photo_shower_head)
                        <img src="{{ asset('storage/' . $checkSheetshower->photo_shower_head) }}"
                            class="photo-shower_head-preview img-fluid mb-3 d-block" style="max-height: 300px">
                    @else
                        <img class="photo-shower_head-preview img-fluid mb-3" style="max-height: 300px">
                    @endif

                    <input type="file" class="form-control" id="photo_shower_head" name="photo_shower_head"
