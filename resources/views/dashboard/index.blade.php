...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="row">
            ...
            <div class="col-lg-6 mb-3">
                <div class="card">
                    <div class="card-header text-center" style="background-color: #6d7fcc; color:white;">Safety Belt</div>
                    <div class="card-body">
                        <div class="chart-container">
                            <canvas id="safetybeltChart" class="img-fluid"></canvas> <!-- Ganti id dengan yang berbeda -->
                        </div>
                    </div>
                </div>
            </div>
