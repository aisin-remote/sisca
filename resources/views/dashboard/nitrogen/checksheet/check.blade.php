...
@section('content')
    ...
    @endif
    <form action="{{ route('nitrogen.process.form') }}" method="POST" class="mb-5 col-lg-12" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="mb-3 col-md-6">
                <label for="tabung_number" class="form-label">No Tabung</label>
                <input type="text" name="tabung_number" id="tabung_number" placeholder="Masukkan No Tabung"
                    class="form-control @error('tabung_number') is-invalid @enderror" value="{{ old('tabung_number') }}"
                    required autofocus>
                @error('tabung_number')
    ...
    <div
        ...
        <a href="/dashboard/nitrogen/checksheet/all-check-sheet" class="btn-link text-primary"
                ...
                <table class="table table-striped table-sm">
                    <thead>
                        <tr class="text-center align-middle">
                            ...
                            <th scope="col">NPK</th>
                            <th scope="col">Nomor Tabung</th>
                            <th scope="col">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($latestCheckSheetNitrogens as $index => $checkSheet)
                            <tr class="text-center align-middle">
