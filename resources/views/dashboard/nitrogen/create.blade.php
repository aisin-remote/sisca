...
@section('content')
    <div
        ...
        <h1>Tambah Data Nitrogen</h1>
    </div>
    <form action="/dashboard/nitrogen/data-nitrogen" method="POST" class="mb-5 col-lg-12" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="mb-3 col-md-6">
                ...
                <input type="text" name="no_tabung" id="no_tabung" placeholder="Masukkan No Tabung"
                    class="form-control @error('no_tabung') is-invalid @enderror" value="{{ old('no_tabung') }}" required
                    autofocus>
                @error('no_tabung')
