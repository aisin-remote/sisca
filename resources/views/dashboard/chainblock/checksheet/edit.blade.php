...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6">
            <form action="{{ route('chainblock.checksheetchainblock.update', $checkSheetchainblock->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="mb-3">
                    <label for="tanggal_pengecekan" class="form-label">Tanggal Pengecekan</label>
                    <input type="date" class="form-control" id="tanggal_pengecekan" value="{{ $checkSheetchainblock->tanggal_pengecekan }}" name="tanggal_pengecekan" required readonly>
                </div>
                <div class="mb-3">
                    <label for="npk" class="form-label">NPK</label>
                    <input type="text" class="form-control" id="npk" name="npk" value="{{ $checkSheetchainblock->npk }}" readonly>
                </div>
                <div class="mb-3">
                    <label for="chainblock_number" class="form-label">Nomor Chain Block</label>
                    <input type="text" class="form-control" id="chainblock_number" value="{{ $checkSheetchainblock->chainblock_number }}" name="chainblock_number" required autofocus readonly>
                </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <div class="input-group">
                    <select class="form-select" id="geared_trolley" name="geared_trolley">
                        ...
                        <option value="OK" {{ old('geared_trolley') ?? $checkSheetchainblock->geared_trolley == 'OK' ? 'selected' : '' }}>OK</option>
                        <option value="NG" {{ old('geared_trolley') ?? $checkSheetchainblock->geared_trolley == 'NG' ? 'selected' : '' }}>NG</option>
                    </select>
            ...
            <div class="mb-3 mt-3" id="catatanField_geared_trolley" style="display:none;">
                ...
                <textarea class="form-control" name="catatan_geared_trolley" id="catatan_geared_trolley" cols="30" rows="5">{{ old('catatan_geared_trolley') ?? $checkSheetchainblock->catatan_geared_trolley}}</textarea>
            </div>
            <div class="mb-3">
                <label for="photo_geared_trolley" class="form-label">Foto Geared Trolley</label>
                <input type="hidden" name="oldImage_geared_trolley" value="{{ $checkSheetchainblock->photo_geared_trolley }}">
                @if ($checkSheetchainblock->photo_geared_trolley)
                    <img src="{{ asset('storage/' . $checkSheetchainblock->photo_geared_trolley) }}" class="photo-geared_trolley-preview img-fluid mb-3 d-block" style="max-height: 300px">
                @else
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <select class="form-select" id="chain_geared_trolley_1" name="chain_geared_trolley_1">
                        <option value="" selected disabled>Select</option>
                        <option value="OK" {{ old('chain_geared_trolley_1') ?? $checkSheetchainblock->chain_geared_trolley_1 == 'OK' ? 'selected' : '' }}>OK</option>
                        <option value="NG" {{ old('chain_geared_trolley_1') ?? $checkSheetchainblock->chain_geared_trolley_1 == 'NG' ? 'selected' : '' }}>NG</option>
                    </select>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <select class="form-select" id="chain_geared_trolley_2" name="chain_geared_trolley_2">
                        <option value="" selected disabled>Select</option>
                        <option value="OK" {{ old('chain_geared_trolley_2') ?? $checkSheetchainblock->chain_geared_trolley_2 == 'OK' ? 'selected' : '' }}>OK</option>
                        <option value="NG" {{ old('chain_geared_trolley_2') ?? $checkSheetchainblock->chain_geared_trolley_2 == 'NG' ? 'selected' : '' }}>NG</option>
                    </select>
            ...
            <div class="mb-3 mt-3" id="catatanField_chain_geared_trolley_2" style="display:none;">
                ...
                <textarea class="form-control" name="catatan_chain_geared_trolley_2" id="catatan_chain_geared_trolley_2" cols="30" rows="5">{{ old('catatan_chain_geared_trolley_2') ?? $checkSheetchainblock->catatan_chain_geared_trolley_2}}</textarea>
            </div>
            <div class="mb-3">
                <label for="photo_chain_geared_trolley_2" class="form-label">Foto Chain Geared Trolley 2</label>
                <input type="hidden" name="oldImage_chain_geared_trolley_2" value="{{ $checkSheetchainblock->photo_chain_geared_trolley_2 }}">
                @if ($checkSheetchainblock->photo_chain_geared_trolley_2)
                    <img src="{{ asset('storage/' . $checkSheetchainblock->photo_chain_geared_trolley_2) }}" class="photo-chain_geared_trolley_2-preview img-fluid mb-3 d-block" style="max-height: 300px">
                @else
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <select class="form-select" id="hooking_geared_trolly" name="hooking_geared_trolly">
                        <option value="" selected disabled>Select</option>
                        <option value="OK" {{ old('hooking_geared_trolly') ?? $checkSheetchainblock->hooking_geared_trolly == 'OK' ? 'selected' : '' }}>OK</option>
                        <option value="NG" {{ old('hooking_geared_trolly') ?? $checkSheetchainblock->hooking_geared_trolly == 'NG' ? 'selected' : '' }}>NG</option>
                    </select>
            ...
            <div class="mb-3 mt-3" id="catatanField_hooking_geared_trolly" style="display:none;">
                ...
                <textarea class="form-control" name="catatan_hooking_geared_trolly" id="catatan_hooking_geared_trolly" cols="30" rows="5">{{ old('catatan_hooking_geared_trolly') ?? $checkSheetchainblock->catatan_hooking_geared_trolly}}</textarea>
            </div>
            <div class="mb-3">
                <label for="photo_hooking_geared_trolly" class="form-label">Foto Hooking Geared Trolly</label>
                <input type="hidden" name="oldImage_hooking_geared_trolly" value="{{ $checkSheetchainblock->photo_hooking_geared_trolly }}">
                @if ($checkSheetchainblock->photo_hooking_geared_trolly)
                    <img src="{{ asset('storage/' . $checkSheetchainblock->photo_hooking_geared_trolly) }}" class="photo-hooking_geared_trolly-preview img-fluid mb-3 d-block" style="max-height: 300px">
                @else
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <select class="form-select" id="latch_hook_atas" name="latch_hook_atas">
                        <option value="" selected disabled>Select</option>
                        <option value="OK" {{ old('latch_hook_atas') ?? $checkSheetchainblock->latch_hook_atas == 'OK' ? 'selected' : '' }}>OK</option>
                        <option value="NG" {{ old('latch_hook_atas') ?? $checkSheetchainblock->latch_hook_atas == 'NG' ? 'selected' : '' }}>NG</option>
                    </select>
            ...
            <div class="mb-3 mt-3" id="catatanField_latch_hook_atas" style="display:none;">
                ...
                <textarea class="form-control" name="catatan_latch_hook_atas" id="catatan_latch_hook_atas" cols="30" rows="5">{{ old('catatan_latch_hook_atas') ?? $checkSheetchainblock->catatan_latch_hook_atas}}</textarea>
            </div>
            <div class="mb-3">
                <label for="photo_latch_hook_atas" class="form-label">Foto Latch Hook Atas</label>
                <input type="hidden" name="oldImage_latch_hook_atas" value="{{ $checkSheetchainblock->photo_latch_hook_atas }}">
                @if ($checkSheetchainblock->photo_latch_hook_atas)
                    <img src="{{ asset('storage/' . $checkSheetchainblock->photo_latch_hook_atas) }}" class="photo-latch_hook_atas-preview img-fluid mb-3 d-block" style="max-height: 300px">
                @else
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <select class="form-select" id="hook_atas" name="hook_atas">
                        <option value="" selected disabled>Select</option>
                        <option value="OK" {{ old('hook_atas') ?? $checkSheetchainblock->hook_atas == 'OK' ? 'selected' : '' }}>OK</option>
                        <option value="NG" {{ old('hook_atas') ?? $checkSheetchainblock->hook_atas == 'NG' ? 'selected' : '' }}>NG</option>
                    </select>
            ...
            <div class="mb-3 mt-3" id="catatanField_hook_atas" style="display:none;">
                ...
                <textarea class="form-control" name="catatan_hook_atas" id="catatan_hook_atas" cols="30" rows="5">{{ old('catatan_hook_atas') ?? $checkSheetchainblock->catatan_hook_atas}}</textarea>
            </div>
            <div class="mb-3">
                <label for="photo_hook_atas" class="form-label">Foto Hook Atas</label>
                <input type="hidden" name="oldImage_hook_atas" value="{{ $checkSheetchainblock->photo_hook_atas }}">
                @if ($checkSheetchainblock->photo_hook_atas)
                    <img src="{{ asset('storage/' . $checkSheetchainblock->photo_hook_atas) }}" class="photo-hook_atas-preview img-fluid mb-3 d-block" style="max-height: 300px">
                @else
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <select class="form-select" id="hand_chain" name="hand_chain">
                        <option value="" selected disabled>Select</option>
                        <option value="OK" {{ old('hand_chain') ?? $checkSheetchainblock->hand_chain == 'OK' ? 'selected' : '' }}>OK</option>
                        <option value="NG" {{ old('hand_chain') ?? $checkSheetchainblock->hand_chain == 'NG' ? 'selected' : '' }}>NG</option>
                    </select>
            ...
            <div class="mb-3 mt-3" id="catatanField_hand_chain" style="display:none;">
                ...
                <textarea class="form-control" name="catatan_hand_chain" id="catatan_hand_chain" cols="30" rows="5">{{ old('catatan_hand_chain') ?? $checkSheetchainblock->catatan_hand_chain}}</textarea>
            </div>
            <div class="mb-3">
                <label for="photo_hand_chain" class="form-label">Foto Hand Chain</label>
                <input type="hidden" name="oldImage_hand_chain" value="{{ $checkSheetchainblock->photo_hand_chain }}">
                @if ($checkSheetchainblock->photo_hand_chain)
                    <img src="{{ asset('storage/' . $checkSheetchainblock->photo_hand_chain) }}" class="photo-hand_chain-preview img-fluid mb-3 d-block" style="max-height: 300px">
                @else
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <select class="form-select" id="load_chain" name="load_chain">
                        <option value="" selected disabled>Select</option>
                        <option value="OK" {{ old('load_chain') ?? $checkSheetchainblock->load_chain == 'OK' ? 'selected' : '' }}>OK</option>
                        <option value="NG" {{ old('load_chain') ?? $checkSheetchainblock->load_chain == 'NG' ? 'selected' : '' }}>NG</option>
                    </select>
            ...
            <div class="mb-3 mt-3" id="catatanField_load_chain" style="display:none;">
                ...
                <textarea class="form-control" name="catatan_load_chain" id="catatan_load_chain" cols="30" rows="5">{{ old('catatan_load_chain') ?? $checkSheetchainblock->catatan_load_chain}}</textarea>
            </div>
            <div class="mb-3">
                <label for="photo_load_chain" class="form-label">Foto Load Chain</label>
                <input type="hidden" name="oldImage_load_chain" value="{{ $checkSheetchainblock->photo_load_chain }}">
                @if ($checkSheetchainblock->photo_load_chain)
                    <img src="{{ asset('storage/' . $checkSheetchainblock->photo_load_chain) }}" class="photo-load_chain-preview img-fluid mb-3 d-block" style="max-height: 300px">
                @else
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <select class="form-select" id="latch_hook_bawah" name="latch_hook_bawah">
                        <option value="" selected disabled>Select</option>
                        <option value="OK" {{ old('latch_hook_bawah') ?? $checkSheetchainblock->latch_hook_bawah == 'OK' ? 'selected' : '' }}>OK</option>
                        <option value="NG" {{ old('latch_hook_bawah') ?? $checkSheetchainblock->latch_hook_bawah == 'NG' ? 'selected' : '' }}>NG</option>
                    </select>
            ...
            <div class="mb-3 mt-3" id="catatanField_latch_hook_bawah" style="display:none;">
                ...
                <textarea class="form-control" name="catatan_latch_hook_bawah" id="catatan_latch_hook_bawah" cols="30" rows="5">{{ old('catatan_latch_hook_bawah') ?? $checkSheetchainblock->catatan_latch_hook_bawah}}</textarea>
            </div>
            <div class="mb-3">
                <label for="photo_latch_hook_bawah" class="form-label">Foto Latch Hook Bawah</label>
                <input type="hidden" name="oldImage_latch_hook_bawah" value="{{ $checkSheetchainblock->photo_latch_hook_bawah }}">
                @if ($checkSheetchainblock->photo_latch_hook_bawah)
                    <img src="{{ asset('storage/' . $checkSheetchainblock->photo_latch_hook_bawah) }}" class="photo-latch_hook_bawah-preview img-fluid mb-3 d-block" style="max-height: 300px">
                @else
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <select class="form-select" id="hook_bawah" name="hook_bawah">
                        <option value="" selected disabled>Select</option>
                        <option value="OK" {{ old('hook_bawah') ?? $checkSheetchainblock->hook_bawah == 'OK' ? 'selected' : '' }}>OK</option>
                        <option value="NG" {{ old('hook_bawah') ?? $checkSheetchainblock->hook_bawah == 'NG' ? 'selected' : '' }}>NG</option>
                    </select>
            ...
            <div class="mb-3 mt-3" id="catatanField_hook_bawah" style="display:none;">
                ...
                <textarea class="form-control" name="catatan_hook_bawah" id="catatan_hook_bawah" cols="30" rows="5">{{ old('catatan_hook_bawah') ?? $checkSheetchainblock->catatan_hook_bawah}}</textarea>
            </div>
            <div class="mb-3">
                <label for="photo_hook_bawah" class="form-label">Foto Hook Bawah</label>
                <input type="hidden" name="oldImage_hook_bawah" value="{{ $checkSheetchainblock->photo_hook_bawah }}">
                @if ($checkSheetchainblock->photo_hook_bawah)
                    <img src="{{ asset('storage/' . $checkSheetchainblock->photo_hook_bawah) }}" class="photo-hook_bawah-preview img-fluid mb-3 d-block" style="max-height: 300px">
                @else
