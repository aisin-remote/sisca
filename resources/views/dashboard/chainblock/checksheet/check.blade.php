...
@section('content')
    ...
    @endif
    <form action="{{ route('chainblock.process.form') }}" method="POST" class="mb-5 col-lg-12" enctype="multipart/form-data">
        @csrf
        <div class="row">
    ...
    <div
        ...
        <a href="/dashboard/chainblock/checksheet/all-check-sheet" class="btn-link text-primary"
                ...
                <table class="table table-striped table-sm">
                    <thead>
                        <tr class="text-center align-middle">
                            ...
                            <th scope="col">NPK</th>
                            <th scope="col">Nomor Chain Block</th>
                            <th scope="col">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($latestCheckSheetChainblocks as $index => $checkSheet)
                            <tr class="text-center align-middle">
