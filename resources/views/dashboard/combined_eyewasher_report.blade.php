...
@section('content')
    <form class="form-inline mb-5 col-lg-12" method="GET" action="{{ route('home.checksheet.eyewasher') }}">
                ...
                <div class="input-group">
                    <select name="tahun" id="tahun" class="form-control">
                        @php
                            ...
                            foreach ($eyewasherData as $eyewasher) {
                                $year = date('Y', strtotime($eyewasher['tanggal_pengecekan']));
                                    ...
                                    @for ($month = 1; $month <= 12; $month++)
                                        <td>
                                            @if (isset($eyewasher['months'][$month]))
                                                @if (in_array('OK', $eyewasher['months'][$month]))
                                                    <span class="badge bg-success">OK</span>
                                                @else
                                                    @php
                                                        $issueCodes = implode('+', $eyewasher['months'][$month]);
                                                    @endphp
    ...
    <div class="card rounded-top-0 mt-0 col-lg-12">
        <div class="card-body">
            ...
            <table class="table table-sm table-borderless">
                <tbody>
                    <tr>
                        <td scope="col">1. Pipa Saluran Air</td>
                        <td scope="col">= a</td>
                        <td scope="col">4. Tuas Eye Wash</td>
                        <td scope="col">= d</td>
                        <td scope="col">7. Tuas Shower</td>
                        <td scope="col">= g</td>
                    </tr>
                    <tr>
                        <td scope="col">2. Wastafel Eye Wash</td>
                        <td scope="col">= b</td>
                        <td scope="col">5. Pijakan</td>
                        <td scope="col">= e</td>
                        <td scope="col">8. Sign</td>
                        <td scope="col">= h</td>
                    </tr>
                    <tr>
                        <td scope="col">3. Kran Eye Wash</td>
                        <td scope="col">= c</td>
                        <td scope="col">6. Instalation Base</td>
                        <td scope="col">= f</td>
                        <td scope="col">9. Shower Head</td>
                        <td scope="col">= i</td>
                    </tr>
                </tbody>
            </table>
