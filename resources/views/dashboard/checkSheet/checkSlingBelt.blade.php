...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="mb-3">
                <label for="pengecekan_lapisan_belt_1" class="form-label">Pengecekan Lapisan Belt</label>
            ...
            <div class="mb-3">
                <label for="pengecekan_lapisan_belt_2" class="form-label">Pengecekan Lapisan Belt</label>
