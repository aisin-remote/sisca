        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    <label for="ok_smoke_detector" class="form-label">OK</label>
                        <input type="number" min="0" step="1" class="form-control" id="ok_smoke_detector"
                            value="0 ?? {{ old('ok_smoke_detector') }}" name="ok_smoke_detector" required autofocus>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3" id="fotoField_smoke_detector" style="display:none;">
                    ...
                    <input type="file" class="form-control" id="photo_smoke_detector" name="photo_smoke_detector" onchange="previewImage('photo_smoke_detector', 'photo-smoke_detector-preview')">
                </div>
                ...
                <div class="mb-3 mt-3" id="catatanField_heat_detector" style="display:none;">
                    ...
                    <textarea class="form-control" name="catatan_heat_detector" id="catatan_heat_detector" cols="30" rows="5">{{ old('catatan_heat_detector') }}</textarea>
                </div>
                ...
                <div class="mb-3 mt-3" id="catatanField_beam_detector" style="display:none;">
                    ...
                    <textarea class="form-control" name="catatan_beam_detector" id="catatan_beam_detector" cols="30" rows="5">{{ old('catatan_beam_detector') }}</textarea>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            tambahFotoButtonSmoke_detector.addEventListener('click', function() {
                ...
                if (fotoFieldSmoke_detector.style.display === 'none') {
                    ...
                    tambahFotoButtonSmoke_detector.innerHTML = '<i data-feather="camera-off" style="width: 16px; height: 16px;"></i>';
                    feather.replace();
                    ...
                    tambahFotoButtonSmoke_detector.innerHTML = '<i data-feather="camera" style="width: 16px; height: 16px;"></i>';
                    feather.replace();
            ...
            tambahFotoButtonHeat_detector.addEventListener('click', function() {
                ...
                if (fotoFieldHeat_detector.style.display === 'none') {
                    ...
                    tambahFotoButtonHeat_detector.innerHTML = '<i data-feather="camera-off" style="width: 16px; height: 16px;"></i>';
                    feather.replace();
                    ...
                    tambahFotoButtonHeat_detector.innerHTML = '<i data-feather="camera" style="width: 16px; height: 16px;"></i>';
                    feather.replace();
            ...
            tambahFotoButtonBeam_detector.addEventListener('click', function() {
                ...
                if (fotoFieldBeam_detector.style.display === 'none') {
                    ...
                    tambahFotoButtonBeam_detector.innerHTML = '<i data-feather="camera-off" style="width: 16px; height: 16px;"></i>';
                    feather.replace();
                    ...
                    tambahFotoButtonBeam_detector.innerHTML = '<i data-feather="camera" style="width: 16px; height: 16px;"></i>';
                    feather.replace();
            ...
            tambahFotoButtonPush_button.addEventListener('click', function() {
                ...
                if (fotoFieldPush_button.style.display === 'none') {
                    ...
                    tambahFotoButtonPush_button.innerHTML = '<i data-feather="camera-off" style="width: 16px; height: 16px;"></i>';
                    feather.replace();
                    ...
                    tambahFotoButtonPush_button.innerHTML = '<i data-feather="camera" style="width: 16px; height: 16px;"></i>';
                    feather.replace();
