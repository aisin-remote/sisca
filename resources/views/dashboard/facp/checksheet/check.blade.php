...
@section('content')
    ...
    @endif
    <form action="{{ route('facp.process.form') }}" method="POST" class="mb-5 col-lg-12" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="mb-3 col-md-6">
                <label for="zona_number" class="form-label">Zona</label>
                <input type="text" name="zona_number" id="zona_number" placeholder="Masukkan No Zona"
                    class="form-control @error('zona_number') is-invalid @enderror" value="{{ old('zona_number') }}"
                    required autofocus>
                @error('zona_number')
    ...
    <div
        ...
        <a href="/dashboard/facp/checksheet/all-check-sheet" class="btn-link text-primary"
        ...
        <div class="card-body">
            <div class="table-responsive col-lg-12">
                <table class="table table-striped table-sm">
                    ...
                    <tbody>
                        @forelse ($latestCheckSheetFacps as $index => $checkSheet)
                            <tr class="text-center align-middle">
