            ...
            <div class="col-md-12 mb-4">
                <div class="card">
                    <div class="card-body text-center"> <!-- Mengatur card-title di tengah -->
                        <h3 class="card-title point-of-view">Mapping Apar Main Station</h3>
                        <!-- Tambahan informasi lainnya jika perlu -->
                    </div>
                    <img src="/foto/lokasi-apar/Mapping APAR Main Station.png" class="card-img-top" alt="Apar Locker & Pos">
                </div>
            </div>
        </div>
