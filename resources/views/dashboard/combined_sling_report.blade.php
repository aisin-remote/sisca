                ...
                <div class="input-group">
                    <select name="tahun" id="tahun" class="form-control">
                        @php
                            ...
                            foreach ($slingData as $sling) {
                                $year = date('Y', strtotime($sling['tanggal_pengecekan']));
                        ...
                        <tbody>
                            @foreach ($slingData as $sling)
                                <tr>
                                    ...
                                    @for ($month = 1; $month <= 12; $month++)
                                        <td>
                                            @if (isset($sling['months'][$month]))
                                                @if (in_array('OK', $sling['months'][$month]))
                                                    <span class="badge bg-success">OK</span>
                                                @else
                                                    @php
                                                        $issueCodes = implode('+', $sling['months'][$month]);
                                                    @endphp
