...
@section('content')
    ...
    <div
        ...
        <div class="form-group">
            <form action="{{ route('export.checksheetstembin') }}" method="POST">
                @method('POST')
                @csrf
                <label for="tahun">Download Check Sheet Tembin</label>
                    ...
                    <select name="tahun" id="tahun" class="form-control">
                        @php
                            ...
                            foreach ($tembinData as $tembin) {
                                $year = date('Y', strtotime($tembin['tanggal_pengecekan']));
